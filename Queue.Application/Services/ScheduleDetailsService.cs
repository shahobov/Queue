...
{
    public class ScheduleDetailsService : BaseService<ScheduleDetails, ScheduleDetailesResponseModel,ScheduleDetilesRequestModel>, IScheduleDetailsService
    {
        private readonly IRepository<ScheduleDetails> _repository;
        private readonly IMapper _mapper;

        public ScheduleDetailsService(IRepository<ScheduleDetails> repository, IMapper mapper)
        {
